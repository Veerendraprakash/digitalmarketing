...
function Signup() {
  ...
  return (
    <div className="h-full bg-gradient-to-tl from-gray-400 to-gray-900 w-full py-16 px-4">
      <div className="flex flex-col items-center justify-center">
        ...
        <span className="ml-2 text-xl font-bold tracking-wide text-gray-400 uppercase cursor-pointer">
          <Link to="/index">SYNERGYSPRINT</Link>
        </span>
