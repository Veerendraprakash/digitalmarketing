        ...
        <div className="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <p className="text-base text-gray-700 md:text-lg">
              You will always get best services here at low rates with 100%
              guarantee.
            </p>
            <br></br>
            <h1 className="text-xl font-medium tracking-wide text-black underline ">
              Web Site Price
            </h1>
          </div>

          <div className="grid max-w-screen-md border-color-white gap-10 md:grid-cols-2 sm:mx-auto">
            <div>
              <div className="p-8 bg-gray-900 rounded border">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-gray-900 transition duration-200 rounded shadow-md bg-white hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
                >
                  Get Now
                </button>
              </div>
            ...
            <div>
              <div className="p-8 bg-gray-900 rounded border">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center justify-center w-full h-12 px-6 font-semibold tracking-wide text-gray-900 transition duration-200 rounded shadow-md bg-white hover:bg-teal-accent-700 focus:shadow-outline focus:outline-none"
                >
                  Get Now
                </button>
              </div>
          ...
          <div className="p-8 bg-gray-100 rounded">
            ...
            <ul className="mb-8 space-y-2">
              <li className="flex items-center">
                ...
                <p className="font-medium text-gray-10">10 deploys per day</p>
              </li>
              <li className="flex items-center">
                <div className="mr-3">
                  <svg
                ...
                <p className="font-medium text-gray-10">10 GB of storage</p>
              </li>
              <li className="flex items-center">
                <div className="mr-3">
                  <svg
                ...
                <p className="font-medium text-gray-10">3 domains</p>
              </li>
              <li className="flex items-center">
                <div className="mr-3">
                  <svg
                ...
                <p className="font-medium text-gray-10">SSL Certificates</p>
              </li>
            </ul>
            <button
              type="submit"
        ...
        <div>
          <div className="p-8 bg-white rounded">
            <div className="mb-4 text-center">
              ...
              <div className="flex items-center justify-center">
                <p className="mr-2 text-6xl font-semibold text-blacklg:text-6xl">
                  $59
                </p>
                <p className="text-lg text-gray-600">/ month</p>
              </div>
            ...
            <ul className="mb-8 space-y-2">
              <li className="flex items-center">
                ...
                <p className="font-medium text-gray-10">100 deploys per day</p>
              </li>
              <li className="flex items-center">
                <div className="mr-3">
                  <svg
                ...
                <p className="font-medium text-gray-10">50 GB of storage</p>
              </li>
              <li className="flex items-center">
                <div className="mr-3">
                  <svg
                ...
                <p className="font-medium text-gray-10">Unlimited domains</p>
              </li>
              <li className="flex items-center">
                <div className="mr-3">
                  <svg
            ...
            <button
              type="submit"
              className="inline-flex items-center justify-center w-full h-12 px-6 font-semibold tracking-wide text-white transition duration-200 rounded shadow-md bg-gray-900 hover:bg-teal-accent-100 focus:shadow-outline focus:outline-none"
            >
              Get Now
            </button>
          </div>
