        ...
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            <div className="ml-auto flex items-center px-6 lg:ml-0 lg:p-0">
              {/* Avatar */}
              <Link
                href="https://th.bing.com/th/id/OIP.Fng9910M2RQR4rQrsJbvDgAAAA?w=181&h=181&c=7&r=0&o=5&dpr=1.3&pid=1.7"
                className="relative inline-flex h-10 w-10 items-center justify-center rounded-full text-white"
              >
                <img
                  src="https://th.bing.com/th/id/OIP.IXo2-EG-CQaJeHN4-UFuZgHaHa?rs=1&pid=ImgDetMain"
                  alt="Login Symbol"
                  className="h-6 w-6"
                />
              </Link>
          ...
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0">
            <li>
              <img
                ...
                alt="Carousel Image 1" // Added alt attribute
                className="m-auto max-h-full w-full max-w-full"
              />
            </li>
            <li>
              {/* ... (rest of your carousel images) */}
